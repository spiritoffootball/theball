				...
				<div class="post">
					...
					<div class="entrytext clearfix">
						...
						<div id="author_avatar">
							<?php echo get_avatar( $team_member->user_email, '200' ); ?>
						</div>

						<div id="author_desc">
							<p><?php echo nl2br( $team_member->description ); ?></p>
							<p><a class="post-edit-link" href="<?php echo get_edit_user_link( $team_member->ID ); ?>"><?php esc_html_e( 'Edit this profile', 'theball' ); ?></a></p>
						</div>
